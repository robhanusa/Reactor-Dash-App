...
app.layout = html.Div([
    dcc.Tabs(className='tab-style', children=[
        dcc.Tab(label='Time Lapse', 
            ...
            dbc.Container([
                ...
                dbc.Row([
                    ...
                    # Image with battery icon
                    dbc.Col([html.Img(id="img_bat",
                                      width = "100em")], 
                            width=2), 
                    
                    # Image with windmill icon
                    dbc.Col([html.Img(id="img_windmill",
                                      width = "100em",
                                      style={"padding-left":"0px"})], 
                            width=3), 
            
                    # Image with grid icon
                    dbc.Col([html.Img(id="img_grid",
                                      width = "100em")], 
                            width=5), 
                    ]), 
        ...
        dcc.Tab(label='Grid Consumption',children=[
            dcc.Graph(figure=dc.fig_grid_cons)
            ])
        ])
    ])
...
@app.callback(Output(component_id='kw_to_battery', component_property='children'),
              ...
              Output(component_id='img_bat', component_property='src'),
              Output(component_id='img_windmill', component_property='src'),
              Output(component_id='img_grid', component_property='src'),
              Output(component_id='kw_gen', component_property='children'),
              Output(component_id='kw_grid', component_property='children'),
