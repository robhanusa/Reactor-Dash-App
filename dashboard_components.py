...
reactor2 = Reactor2()
battery = Battery(bat_start_charge)
...
def distribute_energy(period):
    ...
    return to_r1, to_r2, to_condenser, to_battery, from_grid
...
for hour in range(data_length):
    ...
    for i in range(pph):
        ...
        r1_e_current, r2_e_current, to_condenser, e_to_battery, from_grid = distribute_energy(period)
