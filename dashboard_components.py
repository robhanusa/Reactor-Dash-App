...
bat_start_charge = .5*wec.battery_max
...
battery = pc.Battery(bat_start_charge, wec.battery_max, battery_specs)
...
def update(n_intervals, start_watch, counter):
    ...
    def data_update(counter):
        ...
        # Create timestamp
        state = wec.Hourly_state(math.floor(counter/pph), solar_panel_specs, wind_turbine_specs)
        time = state.time
        ...
        bat_lvl_empty = wec.battery_max - battery_charge[period]
