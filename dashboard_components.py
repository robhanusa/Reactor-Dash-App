...
bat_start_charge = .5*battery_max
...
reactor2 = Reactor2()
sx_filter = Sx_filter()
battery = Battery(bat_start_charge, battery_max)
...
for hour in range(data_length):
    ...
    for i in range(pph):
        ...
        energy_generated = calc_generated_kw()
        generated_kw[period] = energy_generated
        
        # Energy distribution for current period
        energy_tally, r2_e_prev = distribute_energy(energy_generated, energy_tally, r2_e_prev)
        
        # Update battery charge
        battery.charge += battery_charge_differential(energy_flow.to_battery)
        ...
        # Update Sx filter saturation and tally filter changes
        sx_sat_current, sx_filter_tally = update_sx_filter(sx_sat_current, sx_filter_tally)
